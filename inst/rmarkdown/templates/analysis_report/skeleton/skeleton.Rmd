...
## Add figure options for chosen format and 
...
figRef <- local({
    ...
    function(label, caption, prefix = options("figcap.prefix"),
        ...
        if (!missing(caption)) {
            ...
            if(output == 'html'){
              result <- paste0('[', result, '](#', label, '_figure)')
            }
        }
        result
    }
