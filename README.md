...
that a split across multiple RMarkdown files with cross-file dependencies.

- [ ] Ability to declare required RMarkdown documents in yaml header;
    - [ ] Dependencies are resolved and rendered to the requested output
    ...
    - [ ] Make declared dependencies available as reference links so that
      ...
      Markdown syntax.
- [ ] Ability to automatically load the results of cached chunks from other
  other documents;
